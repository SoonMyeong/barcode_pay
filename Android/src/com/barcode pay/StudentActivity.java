...
import com.adapters.viewpageradapter_student;
...
public class StudentActivity extends ActionBarActivity {
	...
	ViewPager pager;
    viewpageradapter_student adapter; 
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter =  new viewpageradapter_student(getSupportFragmentManager(),Titles,Numboftabs);
