...
public class User_product_list extends AppCompatActivity {
	...
	private static final String url = "http://server/My_save_product.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.grid_save_item);
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				Intent intent = new Intent(User_product_list.this,grid_save_detail.class);
				...
				intent.putExtra("barcode_image", productList.get(position).getbarcode_image());
